...
namespace TracNghiemOnline.Areas.Admin.Controllers
{
    public class CauHoiController : BaseController
    {
       ...
       // static List<Kho_CauHoi> cauHois=new List<Kho_CauHoi>();
        ...
        //        file.SaveAs(path);
        //        string LINK1 = "Sheet1";
        //        string conec = string.Format(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\OmanLegalDB.accdb;Persist Security Info=True", path);

        //        if (file.FileName.EndsWith(".xls"))
        //        {
        //            conec = string.Format("Provider=Microsoft.Jet.OLEDB.4.0; data source={0}; Extended Properties=Excel 8.0;", path);
        //        }
        //        else if (file.FileName.EndsWith(".xlsx"))
        //        {
        //            conec = string.Format("Provider=Microsoft.ACE.OLEDB.16.0;Data Source={0};Extended Properties=\"Excel 16.0 Xml;HDR=YES;IMEX=1\";", path);
        //        }
        ...
        //    catch (Exception ex)
        //    {
        //        return Json(new { msg = ""+ ex.Message, status = false }, JsonRequestBehavior.AllowGet);
        //    }
